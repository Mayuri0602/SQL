...
select b.author, sum(quantity*total_price) as total_revenue
from books as b
...
sum(quantity*total_price) over (order by order_date) as running_total_revenue
from orders;
...
select title as book_name, sum(quantity*total_price) as total_revenue
from books as b
join orders as o on b.book_id = o.book_id
group by title
